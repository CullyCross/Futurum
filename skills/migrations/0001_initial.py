    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contributors', models.ManyToManyField(related_name='contributed_to', to=settings.AUTH_USER_MODEL)),
                ('owner', models.ForeignKey(related_name='created_skills', to=settings.AUTH_USER_MODEL, db_constraint=False)),
                ('parent_skills', models.ManyToManyField(related_name='parent_skills_rel_+', to='skills.Skill')),
            ],
            options={
                'abstract': False,
            },
